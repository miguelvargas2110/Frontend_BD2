        ...
        if (responseExamen.success) {
          for (const q of questions) {
            ...
            try {
              ...
              try {
                const responsePreguntaExamen = examenService.crearPreguntaExamen(formDataPreguntaExamen);
                if(!responsePreguntaExamen.success){
                  Swal.fire({
                    icon: "error",
                    text: `Error al crear pregunta examen de la pregunta ${q.id}`,
                  });
                }
              } catch (error) {
                Swal.fire({
              ...
              Swal.fire({
                icon: "error",
                text: `Error al crear pregunta ${q.id}`,
              });
            }
